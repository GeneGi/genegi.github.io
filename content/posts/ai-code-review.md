...
Some thoughts about the AI CR review are: for the AI review workflow it should be a standard across the team, so other team members can run the same flow and get the same feedback, so their coding agent can capture those comments and have those addressed. Humans should review AI CR comments they want to post; if the reviewer doesn't review the comments they provide, they shouldn't expect the code author to read them all and address them. Another thing is, should I just throw those comments to AI and ask AI to help me address them? The major problem of that is currently AI is too strict about corner cases and pushes too hard on it, causing the code to be very complex and hard for humans to understand later.
